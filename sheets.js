        ...
        if (header === 'Image') {
          ...
          if (cellValue.includes('drive.google.com/file/d/')) {
            ...
            if (fileId) {
              ...
              console.log(`📸 Found Google Drive image link for row ${rowIndex + 2}, converted to direct URL`);
            } else {
              console.log(`⚠️ Invalid Google Drive link format in row ${rowIndex + 2}:`, cellValue);
              obj[header] = '';
            }
          } else if (cellValue.trim() !== '') {
            console.log(`⚠️ Non-Google Drive image link found in row ${rowIndex + 2}, ignoring:`, cellValue);
            obj[header] = '';
          } else {
            obj[header] = '';
          }
